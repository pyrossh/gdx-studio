...
public class JavaLexer extends Lexer {
	...
	public static final int
		...
		Literal=54, StringLiteral=55, NullLiteral=56, LPAREN=57, RPAREN=58, 
	...
	public static final String[] tokenNames = {
		...
		"FloatingPointLiteral", "BooleanLiteral", "Literal", "StringLiteral", 
		"'null'", "'('", "')'", "'{'", "'}'", "'['", "']'", "';'", "','", "'.'", 
		"'='", "'>'", "'<'", "'!'", "'~'", "'?'", "':'", "'=='", "'<='", "'>='", 
		"'!='", "'&&'", "'||'", "'++'", "'--'", "'+'", "'-'", "'*'", "'/'", "'&'", 
		"'|'", "'^'", "'%'", "'+='", "'-='", "'*='", "'/='", "'&='", "'|='", "'^='", 
	...
	public static final String[] ruleNames = {
		...
		"Literal", "Single", "StringLiteral", "Strings", 
		"String", "EscapeSequence", "OctalEscape", "UnicodeEscape", "ZeroToThree", 
