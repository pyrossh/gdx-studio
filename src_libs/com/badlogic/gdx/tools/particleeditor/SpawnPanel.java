...
class SpawnPanel extends EditorPanel {
	...
	public SpawnPanel (final ParticlePanel editor, final SpawnShapeValue spawnShapeValue, String name, String description) {
	...
	public void update (ParticlePanel editor) {
